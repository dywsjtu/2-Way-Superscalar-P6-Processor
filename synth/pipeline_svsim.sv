...
module pipeline_svsim (
	...
	output logic [1:0]  proc2mem_command,    	output logic [32-1:0] proc2mem_addr,      	output logic [63:0] proc2mem_data,      	output MEM_SIZE proc2mem_size,          
  ...
  pipeline pipeline( {>>{ clock }}, {>>{ reset }}, {>>{ mem2proc_response }}, 
        ...
        {>>{ proc2mem_addr }}, {>>{ proc2mem_data }}, {>>{ proc2mem_size }}, 
